...
import org.palladium.device.DeviceSettings.Constants;
import org.palladium.device.DeviceSettings.DeviceSettings;
import org.palladium.device.DeviceSettings.R;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    public static final String CLIENT_PACKAGE_PATH = "/data/misc/palladium/client_package_name";
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("org.palladium.device.DeviceSettings",
