...
import com.palladium.device.DeviceSettings.Constants;
import com.palladium.device.DeviceSettings.DeviceSettings;
import com.palladium.device.DeviceSettings.R;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("com.palladium.device.DeviceSettings",
