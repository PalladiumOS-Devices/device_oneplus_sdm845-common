...
import com.palladium.device.DeviceSettings.FileUtils;
import com.palladium.device.DeviceSettings.doze.DozeSettingsActivity;
import com.palladium.device.DeviceSettings.preferences.ProperSeekBarPreference;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), com.palladium.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
